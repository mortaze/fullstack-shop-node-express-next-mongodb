...
const SeoSettings = () => {
  ...
  return (
    <div className="mx-auto p-6 rounded shadow">
      {/* تب‌ها */}
      <div className="flex border-b border-gray-300 mb-6">
        {["عمومی", "پیشرفته", "اسکیما"].map((tab, i) => (
          <button
            key={i}
            className={`flex-1 py-3 text-center font-semibold ${
              activeTab === i + 1
      ...
      <div>
        ...
        {activeTab === 1 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold mb-6 border-l-4 border-green-500 pl-3">عمومی</h2>
            <div className="space-y-4">
              <div className="space-y-1">
                <Label>کلمه کلیدی اصلی</Label>
                <Input
        ...
        {activeTab === 2 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold mb-6 border-l-4 border-orange-500 pl-3">پیشرفته</h2>
            <div className="space-y-4 mb-6">
              <h3 className="font-semibold text-lg mb-3">تنظیمات Meta Robots</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  { key: "index", label: "Index / NoIndex" },
                  { key: "follow", label: "Follow / NoFollow" },
        ...
        {activeTab === 3 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold mb-6 border-l-4 border-blue-500 pl-3">اسکیما</h2>
            <div className="max-w-sm mb-6">
              <Label>نوع اسکیما</Label>
              <select
                className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
